// ESP8266-based 9 channel Wi-Fi relay v1.1
// Developed by Maxim Bortnikov
// For more information and for the circuit of this device visit: https://github.com/Northstrix/ESP8266-based-9-channel-Wi-Fi-relay
#include <ESP8266WiFi.h> 
const char* ssid     = "Switch101";  // Your SSID (Network's name)
const char* password = "espswitch101"; // Password from your network
int ch1 = 14; // pin D5
int ch2 = 12; // pin D6
int ch3 = 13; // pin D7
int ch4 = 15; // pin D8
...
void loop(){
  ...
  client.println("background-color: #121414;");
  ...
  client.println("}");
  client.println(".buttonon {");
  client.println("background-color: #007BEB; ");
  client.println("color: white; ");
  client.println("border: 2px solid #007BEB;");
  client.println("padding: 10px 24px;");
  client.println("}");
  client.println(".buttonon:hover {");
  client.println("background-color: #121414;");
  client.println("color: white;");
  client.println("padding: 10px 24px;");
  client.println("}");
  client.println(".buttonoff {");
  client.println("background-color: #EB2C00;"); 
  client.println("color: white; ");
  client.println("border: 2px solid #EB2C00;");
  client.println("padding: 10px 24px;");
  client.println("}");
  client.println(".buttonoff:hover {");
  client.println("background-color: #121414;");
  client.println("color: white;");
  client.println("padding: 10px 24px;");
  client.println("}");
 ...
 // client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch1=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch1=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
  client.print(" <tr>");
  ...
  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch2=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch2=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print("  <tr>");
...
//  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch3=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch3=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
    client.print(" <tr>");
...
//  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch4=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch4=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
      client.print(" <tr>");
 ...
 // client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch5=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch5=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
  client.print(" <tr>");
...
//  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch6=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch6=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
      client.print(" <tr>");
 ...
 // client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch7=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch7=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
      client.print(" <tr>");
...
//  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch8=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch8=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
      client.print(" <tr>");
...
//  client.print("  <br></br>");
  client.print("  <th>");
  client.println("<a href=\"/ch9=ON\"\" class=buttonon>ON</a>"); // "ON" button
  client.println("<a href=\"/ch9=OFF\"\" class=buttonoff>OFF </a>"); // "OFF" button
  client.print("  </th>");
  client.print(" </tr>");
